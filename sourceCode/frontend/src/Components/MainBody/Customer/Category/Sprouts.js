...
class Sprouts extends React.Component {
    constructor(props){
        super(props)
                ...
                <Header/>
                    ...
                    {console.log()}
                    {
                        this.state.reduxStore.products.map(function(singleFruitObject, index)   {
                                if(singleFruitObject.categoryName.categoryName==='SPROUTS')
...
export default connect(mapStateToProps,{fetchProducts})(Sprouts);
